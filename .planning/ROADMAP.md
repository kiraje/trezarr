...
- [ ] 07-01-PLAN.md — Wave 1: RED test scaffold — tests/web/ package (8 test files) + migration stub for Alembic 0002 (SVC-01..04, AUTO-02, AUTO-05)
...
- [ ] 07-03-PLAN.md — Wave 3A: Continuous monitoring — APScheduler interval poll + POST /webhook enqueue-only handler (AUTO-02)
- [ ] 07-04-PLAN.md — Wave 3B: Config API — config read/write + secret masking + POST /api/test/{sonarr|radarr|bazarr|llm} connection tests (SVC-02)

**Wave 5** *(blocked on Wave 3 completion)*

- [ ] 07-05-PLAN.md — Wave 5: Queue/History/Logs REST API + per-job log capture + React 19 + Vite 7 SPA (Settings/Queue/History/Logs + Retry) (SVC-03, SVC-04)
...
| 7. Web UI & Service Hardening | 0/6 | Not started | - |

...
last_activity: 2026-06-05 -- Server-handover prep: *arr+tuning env vars now bare pass-throughs in docker-compose (5bca229), DEPLOY.md tracked, local .env populated; prepared deploy-agent handover prompt
shipped_milestones:
  - version: v1.0
    name: "MVP"
    phases: "1-10"

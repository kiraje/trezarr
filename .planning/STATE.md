...
last_activity: 2026-06-07 -- quick 260607-dbe: fixed Ep-142 "who is talking" failure — register-aware unhinted-line guardrail in Pass-3 (no name-substitution for literal "you") + per-pass reasoning override (thinking ON for Pass-1 analyze & Pass-2 attribution; Pass-3/4 stay fast). Root cause: live TREZARR_LLM_DISABLE_THINKING=true ran attribution without reasoning. TDD, 466 passed. On branch fix/attribution-hint-gap-reasoning (not yet merged/live-verified)
shipped_milestones:
  - version: v1.0
    name: "MVP"
    phases: "1-10"
...
Status: milestone_archived
Last activity: 2026-06-07 — quick 260607-dbe: fixed the Ep-142 "doesn't know who is talking" failure (diagnosed against live-server output). FIX-A register-aware unhinted-line guardrail in Pass-3 build_translate_prompt (literal "you" → ngươi/các hạ or anh/em/bạn, never a character name when unhinted); FIX-B per-pass reasoning override (thinking ON for Pass-1 analyze + Pass-2 attribution, the reasoning-heavy passes; Pass-3 translate + Pass-4 review stay fast) — root cause was live TREZARR_LLM_DISABLE_THINKING=true running attribution without reasoning. TDD, 466 passed (was ~451), all hard invariants intact. On branch fix/attribution-hint-gap-reasoning — NOT yet merged or live-verified. Prior: quick 260605-dur documented full *arr connection env vars; core value single-episode-verified on deepseek; cross-episode (Phase-06) remains
...
Last session: 2026-06-03T20:13:14.639Z
